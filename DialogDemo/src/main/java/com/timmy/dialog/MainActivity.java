    ...
    public void alertDialog(View view) {
        switch (view.getId()) {
            ...
            case R.id.btn_choice_only:
                AlertDialog onlyChoiceDialog = new AlertDialog.Builder(this)
                        ...
                        .setItems(fruitArray, new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int i) {
                                Toast.makeText(MainActivity.this, "你选择了" + fruitArray[i], Toast.LENGTH_SHORT).show();
                                dialog.dismiss();
                            }
                        })
                        .setNegativeButton("取消", new DialogInterface.OnClickListener() {
            ...
            case R.id.btn_choice_only2:
                AlertDialog onlyChoiceDialog2 = new AlertDialog.Builder(this)
                        ...
                        .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int i) {
                                Toast.makeText(MainActivity.this, "你选择了" + fruitArray[selectPosition], Toast.LENGTH_SHORT).show();
                                dialog.dismiss();
                            }
                        })
                        .setNegativeButton("取消", new DialogInterface.OnClickListener() {
            ...
            case R.id.btn_custom:
                ...
                View customView = layoutInflate.inflate(R.layout.layout, null);
