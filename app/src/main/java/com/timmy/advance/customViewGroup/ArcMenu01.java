 ...
 * @author zhy
 */
public class ArcMenu01 extends ViewGroup implements OnClickListener
{

	private static final String TAG = "ArcMenu01";
	/**
	 * 菜单的显示位置
	 */
	...
	public ArcMenu01(Context context)
	{
		this(context, null);
	}

	public ArcMenu01(Context context, AttributeSet attrs)
	{
	 ...
	 * @param defStyle
	 */
	public ArcMenu01(Context context, AttributeSet attrs, int defStyle)
	{
		...
		TypedArray a = context.getTheme().obtainStyledAttributes(attrs,
				R.styleable.ArcMenu01, defStyle, 0);
		...
		for (int i = 0; i < n; i++)
		{
			...
			switch (attr)
			{
			case R.styleable.ArcMenu01_position:
				...
				break;
			case R.styleable.ArcMenu01_arcRadius:
				// dp convert to px
