 ...
 */
public class CircleMenuLayoutOld extends ViewGroup {
    ...
    public CircleMenuLayoutOld(Context context) {
        super(context);
    }

    public CircleMenuLayoutOld(Context context, AttributeSet attrs) {
        super(context, attrs);
